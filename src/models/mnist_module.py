...
class MNISTLitModule(LightningModule):
    ...
    A LightningModule, is a high-level encapsulation of torch.nn.module, implements 8 key methods:

    - def __init__(self):
    # Define initialization code here, same with torch.nn.Module __init__.

    - def forward(self):
    # Define forward code here, same with torch.nn.Module forward.

    - def setup(self, stage):
    # Things to set up before each stage, "fit", "validate", "test", "predict".
